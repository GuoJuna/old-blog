...
![list](https://www.guojun49.github.io/assets/images/2016/1024list.jpg)  

在地址栏```https://xxxxxx.biz/thread0806.php?fid=16&search=&page=```后面拼1、2、3等于就是访问图片区第一页、第二页、第三页的列表页。根据这些列表页就可以爬出具体的每一个图片页的地址，类似上图的地址：```htm_data/16/1611/2114702.html``` 在地址的前面拼接上主站地址就是具体的图片页了。所以根据以上的分析：通过循环地址栏找到不同的列表页在根据列表页找到具体的图片页
...
![page](https://www.guojun49.github.io/assets/images/2016/1024page.jpg) 
...
def downImg(data):
	for link,t in set(re.findall(r'([https|https]:[^\s]*?(jpg|png|gif))', str(data))):
...
url = "https://xxxx.biz/htm_data/16/1611/2115193.html"
openUrl(url)
...
![result](https://www.guojun49.github.io/assets/images/2016/1024result.jpg)  
...
[爬取豆瓣首页图片](https://blog.csdn.net/fly_yr/article/details/51525945)

[使用Python爬取1024上的图片](https://zzydev.com/python/2016/05/20/Python1024)
