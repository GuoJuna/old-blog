...
![](https://www.itmind.net/assets/images/2017/springcloud/bff.png)
...
![](https://www.itmind.net/assets/images/2017/springcloud/bff-process.png)
...
zuul.routes.baidu.url=https://www.guojun49.github.io/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```https://localhost:8888/it/spring-cloud```，看到页面返回了：```https://www.guojun49.github.io/spring-cloud ``` 页面的信息，如下：

 
![](https://www.itmind.net/assets/images/2017/springcloud/zuul-01.jpg)
...
-------------
**作者：纯洁的微笑**  
**出处：[https://www.guojun49.github.io/](https://www.guojun49.github.io/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 
