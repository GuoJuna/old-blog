...
**优点**：图片访问是很消耗服务器资源的（因为会涉及到操作系统的上下文切换和磁盘I/O操作），分离出来后，Web/App服务器可以更专注发挥动态处理的能力；独立存储，更方便做扩容、容灾和数据迁移；方便做图片访问请求的负载均衡，方便应用各种缓存策略（https Header、Proxy Cache等），也更加方便迁移到CDN。
...
![](https://www.itmind.net/assets/images/2018/fastdfs/fastdfs_arch.png)
...
![](https://www.itmind.net/assets/images/2018/fastdfs/upload.png)
...
![](https://www.itmind.net/assets/images/2018/fastdfs/download.png)
...
![](https://www.itmind.net/assets/images/2018/fastdfs/sync.png)
...
![](https://www.itmind.net/assets/images/2018/fastdfs/id.png)
...
![](https://www.itmind.net/assets/images/2018/fastdfs/find.jpg)


**如何搭建FastDFS？参考我博客的这篇文章[FastDFS 集群 安装 配置
](https://www.guojun49.github.io/fastdfs/2017/10/10/cluster-building-fastdfs.html)**，下图为某用户搭建的架构示意图

![](https://www.itmind.net/assets/images/2018/fastdfs/install.png)
