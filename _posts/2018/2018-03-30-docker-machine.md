...
上篇文章[Docker(四)：Docker 三剑客之 Docker Compose ](http://www.guojun49.github.io/docker/2018/03/22/docker-compose.html)介绍了 Docker Compose，这篇文章我们来了解 Docker Machine 。
