...
```xml
    <!--自定义批量插入--> 
    <plugin type="com.bxd.core.plugin.BatchInsertPlugin" />
```
```xml
    <!--自定义批量更新--> 
    <plugin type="com.bxd.core.plugin.BatchUpdatePlugin" />
```

## 自定义注释

创建一个类实现CommentGenerator接口,重写其中方法
...
<generatorConfiguration>
	...
	<context id="MySqlTables" targetRuntime="MyBatis3">
		...
		<jdbcConnection driverClass="com.mysql.jdbc.Driver" 
			connectionURL="jdbc:mysql://47.99.45.35:3306/pv_web2"
